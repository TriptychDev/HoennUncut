...
{//                   Defender -->
 //  Attacker         Normal   Rugged  Flying  Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy
    ...
    [TYPE_RUGGED]   = {______, ______, X(0.5), X(0.5), ______, X(2.0), X(0.5), X(0.0), X(2.0), ______, ______, ______, ______, ______, X(0.5), X(2.0), ______, ______, ______},
    ...
    [TYPE_BUG]      = {______, X(0.5), X(0.5), X(0.5), ______, X(0.5), ______, ______, X(0.5), ______, X(0.5), ______, X(2.0), ______, X(2.0), ______, ______, X(2.0), ______},
    ...
    [TYPE_GRASS]    = {______, X(0.5), ______, X(0.5), ______, X(2.0), X(0.5), ______, X(0.5), ______, X(0.5), X(2.0), X(0.5), ______, ______, X(0.5), X(0.5), ______, ______},
...
#endif
    [TYPE_FAIRY]    = {______, X(2.0), ______, X(0.5), ______, ______, X(0.5), ______, ______, ______, X(0.5), ______, ______, ______, ______, ______, X(2.0), X(2.0), ______},
};
