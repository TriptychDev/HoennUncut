...
{//                   Defender -->
 //  Attacker         Normal   Rugged   Bird   Poison  Ground   Rock    Bug     Ghost   Steel  Mystery  Fire   Water   Grass  Electric Psychic   Ice   Dragon   Dark   Fairy
    [TYPE_NORMAL]   = {______, ______, ______, ______, ______, X(0.5), ______, X(0.0), X(0.5), ______, ______, ______, ______, ______, ______, ______, X(0.5), ______, X(0.5)},
    [TYPE_RUGGED]   = {______, X(0.5), X(0.5), ______, ______, X(2.0), ______, X(0.5), X(2.0), ______, ______, ______, ______, ______, X(0.5), X(2.0), ______, ______, ______},
    [TYPE_FLYING]   = {______, ______, ______, ______, ______, X(0.5), X(2.0), ______, X(0.5), ______, ______, ______, X(2.0), X(0.5), ______, ______, ______, ______, ______},
    [TYPE_POISON]   = {X(2.0), X(0.5), ______, X(0.5), ______, X(0.5), ______, ______, X(0.0), ______, ______, ______, X(2.0), ______, ______, ______, X(0.5), X(0.5), X(2.0)},
    [TYPE_GROUND]   = {______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______, ______},
    [TYPE_ROCK]     = {______, ______, X(2.0), ______, ______, X(0.5), X(2.0), ______, X(0.5), ______, X(2.0), ______, ______, X(2.0), ______, X(2.0), ______, ______, ______},
    [TYPE_BUG]      = {______, X(0.5), X(0.5), X(0.5), ______, X(0.5), ______, ______, X(0.5), ______, X(0.5), ______, X(2.0), ______, X(2.0), ______, ______, X(2.0), X(2.0)},
#if B_STEEL_RESISTANCES >= GEN_6
    [TYPE_GHOST]    = {X(0.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), X(2.0)},
#else
...
#endif
    [TYPE_STEEL]    = {______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), ______, ______, X(0.5), ______, X(0.5), ______, X(2.0), ______, ______, ______},
    ...
    [TYPE_FIRE]     = {______, X(0.5), ______, ______, ______, ______, X(2.0), ______, X(2.0), ______, X(0.5), X(0.5), X(2.0), ______, ______, X(2.0), X(0.5), ______, ______},
    [TYPE_WATER]    = {______, ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, ______, X(0.5), ______, ______},
    [TYPE_GRASS]    = {______, X(0.5), ______, X(0.5), ______, X(2.0), X(0.5), ______, X(0.5), ______, X(0.5), X(2.0), ______, ______, ______, X(0.5), X(0.5), ______, ______},
    [TYPE_ELECTRIC] = {______, X(0.5), X(2.0), ______, ______, X(0.0), ______, ______, ______, ______, ______, X(2.0), X(0.5), X(0.5), ______, ______, X(0.5), ______, ______},
    [TYPE_PSYCHIC]  = {______, X(2.0), ______, X(2.0), ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, ______, ______, X(0.5), ______, X(0.5), X(0.0), ______},
    [TYPE_ICE]      = {______, X(0.5), X(2.0), ______, ______, X(0.5), X(2.0), ______, X(0.5), ______, X(0.5), X(0.5), X(2.0), ______, ______, X(0.5), X(2.0), ______, ______},
...
#if B_STEEL_RESISTANCES >= GEN_6
    [TYPE_DARK]     = {______, ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, ______, ______, ______, ______, X(2.0), ______, ______, X(0.5), X(0.5)},
#else
...
#endif
    [TYPE_FAIRY]    = {______, X(2.0), ______, X(0.5), ______, ______, X(0.5), ______, X(0.5), ______, ______, ______, X(0.5), ______, ______, ______, X(2.0), X(2.0), ______},
};
...
bool8 GetBattlerAirborne(u32 battler)
{
    if(gBattleMons[battler].isAirborne == 1)
        return TRUE;
    else
        return FALSE;
}
...
static bool32 IsBattlerGrounded2(u32 battler, bool32 considerInverse)
{
    ...
    if (GetBattlerAbility(battler) == ABILITY_LEVITATE)
        return FALSE;
    if (GetBattlerAirborne(battler) && (!considerInverse || !FlagGet(B_FLAG_INVERSE_BATTLE)))
        return FALSE;
    return TRUE;
}
...
static inline u32 CalcMoveBasePowerAfterModifiers(u32 move, u32 battlerAtk, u32 battlerDef, u32 moveType, bool32 updateFlags, u32 atkAbility, u32 defAbility, u32 holdEffectAtk, u32 weather)
{
    ...
    case ABILITY_SAND_FORCE:
        if ((moveType == TYPE_STEEL || moveType == TYPE_ROCK || moveType == TYPE_RUGGED)
...
static inline void MulByTypeEffectiveness(uq4_12_t *modifier, u32 move, u32 moveType, u32 battlerDef, u32 defType, u32 battlerAtk, bool32 recordAbilities)
{
    ...
    else if ((moveType == TYPE_RUGGED || moveType == TYPE_NORMAL) && defType == TYPE_GHOST && gBattleMons[battlerDef].status2 & STATUS2_FORESIGHT && mod == UQ_4_12(0.0))
    {
        mod = UQ_4_12(1.0);
    }
    else if ((moveType == TYPE_RUGGED || moveType == TYPE_NORMAL) && defType == TYPE_GHOST && GetBattlerAbility(battlerAtk) == ABILITY_SCRAPPY && mod == UQ_4_12(0.0))
    {
        mod = UQ_4_12(1.0);
        if (recordAbilities)
...
bool8 CanMonParticipateInSkyBattle(struct Pokemon *mon)
{
    ...
    bool8 isFlyingType = gSpeciesInfo[species].isAirborne;
