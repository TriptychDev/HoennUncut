...
#define GALLADE_MISC_INFO                                   \
        .types = { TYPE_PSYCHIC, TYPE_RUGGED },           \
        .catchRate = 45,                                    \
        .evYield_Attack = 3,                                \
...
#define AGGRON_MISC_INFO                                        \
    ...
    [SPECIES_MEDITITE] =
    {
        ...
        .baseSpAttack  = 40,
        .baseSpDefense = 55,
        .types = { TYPE_RUGGED, TYPE_PSYCHIC },
        .catchRate = 180,
        .expYield = 56,
        .evYield_Speed = 1,
        .genderRatio = PERCENT_FEMALE(50),
...
#define GLALIE_MISC_INFO                                    \
    ...
    [SPECIES_LUVDISC] =
    {
        ...
        LEARNSETS(Luvdisc),
        .evolutions = EVOLUTION({EVO_MOVE, MOVE_HEAL_PULSE, SPECIES_ALOMOMOLA}),
    },
