...
#define OINKOLOGNE_MISC_INFO                                \
    ...
    [SPECIES_PAWMO] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 40,
        .types = { TYPE_ELECTRIC, TYPE_RUGGED },
        .catchRate = 80,
        .expYield = 123,
        .evYield_Speed = 2,
        .genderRatio = PERCENT_FEMALE(50),
...
#define TATSUGIRI_MISC_INFO                                                     \
    ...
    [SPECIES_IRON_HANDS] =
    {
        ...
        .baseSpAttack  = 50,
        .baseSpDefense = 68,
        .types = { TYPE_RUGGED, TYPE_ELECTRIC },
        .catchRate = 50,
        .expYield = 285,
        .evYield_Attack = 3,
        .genderRatio = MON_GENDERLESS,
