...
#define B_WHITEOUT_MONEY            GEN_1 // In Gen4+, the amount of money lost by losing a battle is determined by the amount of badges earned. Previously, it would cut the current money by half. (While this change was also in FRLG, for the sake of simplicity, setting this to GEN_3 will result in RSE behavior.)
...
#define B_TRAINER_EXP_MULTIPLIER    GEN_1 // In Gen7+, trainer battles no longer give a 1.5 multiplier to EXP gain.
...
// Damage settings
#define B_BURN_DAMAGE               GEN_1 // In Gen7+, burn damage is 1/16th of max HP instead of 1/8th. Also applies to Frostbite.
